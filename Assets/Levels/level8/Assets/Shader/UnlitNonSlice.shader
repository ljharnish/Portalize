...
void main ()
{
  ...
  tmpvar_5 = tmpvar_10;
  c_1.xyz = (tmpvar_2 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((tmpvar_5 * 2.0))));
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  shadow_5 = tmpvar_7;
  c_1.xyz = (tmpvar_2 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((shadow_5 * 2.0))));
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
}
